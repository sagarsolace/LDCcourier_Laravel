...
add_action('wp_head', function () {
    if (is_front_page()) {
        ...
        href="/assets/images/2026/03/logo_black-1.webp"
        imagesrcset="/assets/images/2026/03/logo_black-1.webp 320w"
        imagesizes="100vw"
        fetchpriority="high">';

        echo '<link rel="preload" href="/wp-content/uploads/fonts/inter.woff2"
